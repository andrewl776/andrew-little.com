...
```{r, echo=FALSE, width="677"}
knitr::include_graphics('process_diagram.jpeg')
```


![](process_diagram.jpeg){width="677"}
...
![Before removing stopwords](most_common_words.png)

![After removing stopwords](most_common_words2.png)
